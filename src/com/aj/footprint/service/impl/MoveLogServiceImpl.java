...
public class MoveLogServiceImpl implements MoveLogServiceI {

	@Autowired
	private BaseDaoI<TMoveLog> tMoveLog;
	...
	public void save(TMoveLog p) {
		tMoveLog.save(p);
	}

	public void update(TMoveLog p) {
		tMoveLog.update(p);
	}

	public void delete(TMoveLog p) {
		tMoveLog.delete(p);
	}
